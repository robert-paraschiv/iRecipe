...
public class FriendRequestActivity extends AppCompatActivity implements RecipeAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        documentID = getIntent().getStringExtra("friend_id");

        UserNameTv = findViewById(R.id.userprofileFragment_user_name_TextView);
        UserUsernameTv = findViewById(R.id.userprofileFragment_userName_TextView);
        UserDescriptionTv = findViewById(R.id.userprofileFragment_user_description_TextView);
        mProfileImage = findViewById(R.id.userprofileFragment_profileImage);
        mRecyclerView = findViewById(R.id.userprofile_recycler_view);
        mAddFriendButton = findViewById(R.id.userprofile_addFriend_MaterialButton);
...
//                                    });
                                    ...
                                    usersReference.document(FirebaseAuth.getInstance().getCurrentUser().getUid()).collection("FriendList").document(documentID)
                                        ...
                                        public void onSuccess(Void aVoid) {
                                            usersReference.document(documentID).collection("FriendList")
                                                ...
                                                @Override
                                                public void onSuccess(Void aVoid) {
                                                    Toast.makeText(FriendRequestActivity.this, "Cancelled friend request", Toast.LENGTH_SHORT).show();
                                                    mAddFriendButton.setText("Add Friend");
                                                    mAddFriendButton.setEnabled(true);
                                                }
                                            });
                                    ...
                                    usersReference.document(FirebaseAuth.getInstance().getCurrentUser().getUid()).collection("FriendList").document(documentID)
                                        ...
                                        public void onSuccess(Void aVoid) {
                                            ...
                                            usersReference.document(documentID).collection("FriendList")
                                                ...
                                                @Override
                                                public void onSuccess(Void aVoid) {
                                                    Toast.makeText(FriendRequestActivity.this, "Accepted friend request", Toast.LENGTH_SHORT).show();
                                                }
                                            });
                                        }
                                    });
                                ...
                                usersReference.document(FirebaseAuth.getInstance().getCurrentUser().getUid()).collection("FriendList").document(documentID)
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        ...
                                        usersReference.document(documentID).collection("FriendList")
                                            ...
                                            @Override
                                            public void onSuccess(Void aVoid) {
                                                Toast.makeText(FriendRequestActivity.this, "Sent friend request", Toast.LENGTH_SHORT).show();
                                                mAddFriendButton.setText("Cancel Friend request");
                                            }
                                        });
                                    }
    ...
    private void buildRecyclerView() {
        ...
        mLayoutManager = new LinearLayoutManager(FriendRequestActivity.this);
        ...
        mAdapter.setOnItemClickListener(FriendRequestActivity.this);
    }
        ...
        mAdapter.setOnItemClickListener(new RecipeAdapter.OnItemClickListener() {
            ...
            public void onFavoriteClick(final int position) {
                ...
                if (userFavRecipesList.contains(id)) {
                                ...
                                if (!userFavDocId.equals("") && !mRecipeList.get(position).getFavorite()) {
                                    currentRecipeSubCollection.document(userFavDocId).delete()
                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                @Override
                                                public void onSuccess(Void aVoid) {
                                                    if (FriendRequestActivity.this != null)
                                                        Toast.makeText(FriendRequestActivity.this, "Removed from favorites", Toast.LENGTH_SHORT).show();
                                                }
                                            });
                                } else {
                    ...
                    Toast.makeText(FriendRequestActivity.this, "Added " + title + " to favorites", Toast.LENGTH_SHORT).show();
                }
